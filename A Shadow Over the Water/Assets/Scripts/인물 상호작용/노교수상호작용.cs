...
public class 노교수상호작용 : MonoBehaviour
{
	...
	public void 멜리사대화()
    {
        ...
        else
        {
			if (숫자 == 1)
			{
				인터렉션컨트롤러.노교수_1일차낮_반복대화1();
			}
			else if (숫자 == 2)
			{
				인터렉션컨트롤러.노교수_1일차낮_반복대화2();
			}
