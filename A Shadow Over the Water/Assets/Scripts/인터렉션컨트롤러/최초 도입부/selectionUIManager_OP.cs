...
public class selectionUIManager_OP : MonoBehaviour
{
    public DialogManager_OP theDM;

    public DialogManager_OP dialogManager;
    public GameObject 첫번째_선택지_긍정_버튼;
    public GameObject 첫번째_선택지_부정_버튼;


    public GameObject 엘라심리학선택지버튼;
    public Text 엘라심리학선택지텍스트;

    public InterctionController_OP interctionController;
    public rollet 룰렛머신;
    public InterctionController_OP interctionController2;
    ...
    public void 선택지출력1()
    {
        ...
        첫번째_선택지_긍정_버튼.SetActive(true);
        첫번째_선택지_부정_버튼.SetActive(true);
    ...
    public void 선1예선()
    {
        ...
        첫번째_선택지_긍정_버튼.SetActive(false);
        첫번째_선택지_부정_버튼.SetActive(false);
        dialogManager.onButtonSetterF();
        interctionController.선1예선택();
