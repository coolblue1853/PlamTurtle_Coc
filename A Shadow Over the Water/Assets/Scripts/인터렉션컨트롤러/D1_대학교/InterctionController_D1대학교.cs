...
public class InterctionController_D1대학교 : MonoBehaviour
{


    //멜리사 대사

    public GameObject 대학생_1일차낮_최초대사;
    public GameObject 대학생_1일차낮_반복대사1;
    public GameObject 대학생_1일차낮_반복대사2;
    public GameObject 대학생_1일차낮_반복대사3;
    public GameObject 대학생_1일차낮_관찰력판정;
    public GameObject 대학생_1일차낮_악몽키워드;
    public GameObject 대학생_1일차낮_불면증키워드;
    public GameObject 대학생_1일차낮_그외키워드;

    public GameObject 대학생_1일차낮_관찰력실패;
    ...
    public DialogManager_D1대학교 기능판정DM;
    ...
    public void 대학생_1일차낮_최초대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_최초대사.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_반복1대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_반복대사1.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_반복2대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_반복대사2.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_반복3대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_반복대사3.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_관찰력기능대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_관찰력판정.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_악몽대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_악몽키워드.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_불면증대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_불면증키워드.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_그외키워드대화()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_그외키워드.transform.GetComponent<interactionEvent>().GetDialogs());

        }
    }
    public void 대학생_1일차낮_실패()
    {
        ...
        if (theDM.isDialogON == false)
        {
            ...
            theDM.ShowDialog(대학생_1일차낮_관찰력실패.transform.GetComponent<interactionEvent>().GetDialogs());
